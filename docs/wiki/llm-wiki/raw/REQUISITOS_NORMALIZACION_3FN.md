<!-- Snapshot inmutable ingerido 2026-09-17 desde `database/REQUISITOS_NORMALIZACION_3FN.md`. No editar aquí. Esta actividad la resuelve el usuario/estudiante; ver wiki/decisiones.md. -->
